...
router.route("/posts/create").get(adminController.createPosts);
...
router.route("/categories/delete/:id").delete(adminController.deleteCategories);
...
router.route("/blogPosts/create").get(adminController.createBlogPosts);

router
  .route("/blogPosts/edit/:id")
  .get(adminController.editBlogPosts)
  .put(adminController.editBlogPostUpdateRoute);

router.route("/blogPosts/delete/:id").delete(adminController.deleteBlogPosts);
...
router
  .route("/levels/edit/:id")
  .get(adminController.editLevel)
  .post(adminController.editLevelSubmit);

router.route("/levels/delete/:id").delete(adminController.deleteLevels);
...
router.route("/subjects/create").get(adminController.createSubjects);
...
router.route("/subjects/delete/:id").delete(adminController.deleteSubjects);
...
router.route("/chapters/create").get(adminController.createChapters);

router
  .route("/chapters/edit/:id")
  .get(adminController.editChapter)
  .put(adminController.editChapterSubmit);

router.route("/chapters/delete/:id").delete(adminController.deleteChapters);
...
router.route("/fileuploads/create").get(adminController.createFiles);

router.route("/fileuploads/delete/:id").delete(adminController.deleteFiles);
...
router.route("/users/create").get(adminController.registerGet);
